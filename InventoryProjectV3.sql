...
INSERT INTO `categories` VALUES (1,'Shonen','2020-05-03 13:50:53','2020-05-03 15:41:57'),(2,'isekai','2020-05-03 15:05:03','2020-05-03 15:42:38'),(3,'Shojo','2020-05-04 12:41:54','2020-05-04 12:41:54'),(4,'adventure','2020-05-19 01:01:14','2020-05-19 01:01:14');
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`fk_PID`) REFERENCES `products` (`PID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,1,1,9.99),(2,3,4,20.00);
...
CREATE TABLE `orders_products` (
  ...
  CONSTRAINT `orders_products_ibfk_2` FOREIGN KEY (`fk_CID`) REFERENCES `customer` (`CID`),
  CONSTRAINT `orders_products_ibfk_3` FOREIGN KEY (`fk_PID`) REFERENCES `products` (`PID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-19  2:26:51
